  ...
  return (
    <div style={{ textAlign: "center", padding: "20px", maxWidth: "500px", margin: "auto" }}>
      ...
      <div style={{ marginBottom: "20px", padding: "10px", background: "#f8f9fa", borderRadius: "8px" }}>
        <label style={{ display: "block", marginBottom: "5px", fontWeight: "bold" }}>Pilih Karyawan:</label>
        <select 
      ...
      <div style={{ marginTop: "20px", padding: "15px", borderRadius: "12px", border: "1px solid #d0e3ff" }}>
        <p>Status: <strong>{status}</strong></p>
        <div style={{ textAlign: "left", fontSize: "0.8em", color: "#666" }}>
            <p><strong>Device ID:</strong> {deviceId || "Loading..."}</p>
            <p><strong>Lokasi:</strong> {lat ? `${lat.toFixed(5)}, ${lng.toFixed(5)}` : "Mencari GPS..."}</p>
